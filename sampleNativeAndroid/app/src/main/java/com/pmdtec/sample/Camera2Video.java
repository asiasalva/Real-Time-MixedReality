        ...
        public class Camera2Video extends Fragment
            ...
            private static Size chooseVideoSize(Size[] choices) {
                ...
                for (Size size : choices) {
                    Log.d(TAG,"choices:"+size.getHeight() +", "+size.getWidth());
            ...
            public void onViewCreated(final View view, Bundle savedInstanceState) {
                ...
                Log.d(TAG,"R.id.texture"+R.id.texture);
                mButtonVideo = (Button) view.findViewById(R.id.btnStartRec);
                Log.d(TAG,"this:"+this);
            ...
            private void openCamera(int width, int height) {
                ...
                Log.e(TAG,"m.width: "+ mTextureView.getWidth());
                Log.e(TAG,"m.height: "+ mTextureView.getHeight());
            ...
            private void setUpMediaRecorder() throws IOException {
                Log.d(TAG,"set up media recorder");
                final Activity activity = getActivity();
                if (null == activity) {
                    return;
                }
            ...
            public String stopRecordingVideo() {
                ...
                Log.d(TAG,"Dopo l'if di stop recording");
                mNextVideoAbsolutePath = null;
                startPreview();
                Log.d(TAG,"sono dopo start preview.");
                return "";
            }
