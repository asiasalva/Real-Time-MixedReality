 ...
 *   8   for 8-bit realtimemr values (the usual setting)
 *   12  for 12-bit realtimemr values
...
/* Representation of a single realtimemr (pixel element value).
 ...
 * RESTRICTIONS:
 * 1. The realtimemr applications cjpeg,djpeg do NOT support modified RGB formats.
